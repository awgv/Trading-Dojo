...
<div class="modal fade" id="publishSignedOffer" tabindex="-1" role="dialog" aria-labelledby="publishingSignedOffer" aria-hidden="true">
	<div class="modal-dialog modal-smaller">
		<div class="modal-content">
			...
			<div class="modal-body js-modal-create">
				<div class="continer-fluid">
					{!! Form::open([
						...
						'class'       => 'sell_item_form_authed js-account-signed',
						'files'       => false,
						'method'      => 'post'
					]) !!}
						<div class="row">
							...
							<div class="col-md-7">
								<fieldset disabled>
									<div class="form-group">
										...
										{!! Form::text('sell_user_ign', $user->name, [
											'id'          => 'user_ign',
											'class'       => 'form-control',
			...
			<div class="modal-footer js-modal-footer-create">
				...
				<button type="button" class="btn btn-primary sell_item_form_submit_authed">Publish</button>
			</div>
		</div>
	</div>
</div>